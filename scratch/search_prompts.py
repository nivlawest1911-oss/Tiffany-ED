...
# Let's search for mentions of "keyframes" or "prompts" or "Superintendent Close-up"
matches = [m.start() for m in re.finditer(r"Superintendent Close-up|Golden Owl Shield|Instant Insights|Smart Grouping|Progress Monitoring|Final Combined Hero", text, re.IGNORECASE)]
for m in matches:
