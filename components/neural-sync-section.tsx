...
import { Settings, Activity, Cpu, Zap, Play, Rocket, Brain, Shield, Heart, Target } from "lucide-react"

const skillPillars = [
  { name: "Pedagogical Nuance", icon: Brain },
  { name: "Compliance Logic", icon: Shield },
          ...
          <div className="flex items-center justify-center gap-2 md:gap-4 mb-8">
            {["programs", "diagnostics", "simulators"].map((tab) => (
              <button
                ...
                className={`px-4 md:px-6 py-2 rounded-lg text-sm font-bold tracking-wider transition-all ${
                  activeTab === tab ? "bg-gray-900 text-white" : "bg-gray-200 text-gray-600 hover:bg-gray-300"
                }`}
              >
          ...
          {activeTab === "programs" && (
            <>
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-sm text-gray-500">Estimated Drift: 15min</p>
              </div>

              <div className="mt-12 text-center">
                <p className="text-sm text-gray-500 mb-2">Goal: 404 Sovereignty Points</p>
