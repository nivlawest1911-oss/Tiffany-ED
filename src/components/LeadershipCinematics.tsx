...
const CINEMATIC_ASSETS = [
    {
        ...
        briefing: {
            ...
            content: "Connection Secure. We are observing the Synthesis Phase of an Alabama-aligned IEP. Notice the strategic mapping of student assessment data directly into measurable SMART goals. The engine doesn't just fill forms; it audits for IDEA fidelity and FAPE compliance in real-time according to Alabama SDE Chapter 290-8-9 guidelines. By leveraging a multi-variate database of 40,000+ instructional strategies, we ensure every scholar has a legally robust and instructionally sound success path.",
    ...
    },
    {
        ...
        briefing: {
            ...
            content: "Global Connection Established. This strategic network facilitates the sharing of instructional capital across 48 states. We are currently observing a Title I recovery protocol where high-impact tutoring strategies from high-performing districts are synthesized into actionable tactical briefs for emerging districts. All exchanges are monitored for federal compliance and instructional ROI, ensuring absolute accountability for state and federal funding streams.",
            metrics: ["48 State Sync", "1M+ Daily Centers", "Zero-Latency Share"],
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                <div className="mb-20">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-zinc-400 text-[10px] font-black uppercase tracking-[0.3em] mb-6">
                        ...
                        <span>Leadership Vision Gallery</span>
                    </div>
                    ...
                    {CINEMATIC_ASSETS.map((asset, i) => (
                        ...
                        >
                            <div className="relative aspect-[4/5] rounded-[3rem] overflow-hidden border border-white/10 bg-zinc-900 shadow-2xl transition-all duration-700 group-hover:border-white/30 group-hover:scale-[1.02]">
                                ...
                                <div className="absolute inset-0 bg-[linear-gradient(rgba(18,18,18,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))] z-20 bg-[length:100%_2px,3px_100%] pointer-events-none opacity-20" />
                            ...
                            <div className="lg:w-1/2 p-12 overflow-y-auto custom-scrollbar flex flex-col">
                                ...
                                <div className="mb-10">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <span className="text-xs font-black text-indigo-400 uppercase tracking-widest">Policy Alignment: {selectedAsset.briefing.policy}</span>
                                    </div>
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        // Trigger Action
                                        alert(`Strategy implemented: ${selectedAsset.title}`);
                                    }}
                                >
                                    <Zap size={16} />
