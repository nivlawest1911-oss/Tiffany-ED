...
export default function LeadershipTraining() {
    ...
    const heroProgram = {
        title: "Personalized Leadership Plan",
        subtitle: "Professional Development v4.0",
        goal: "Goal: 404 Professional Credits",
        skills: ["Educational Leadership", "State Compliance", "Administrative Oversight", "Community Engagement"],
        nextUp: [
        ...
        <div className="p-10 rounded-[2.5rem] bg-stone-50 text-zinc-900 border border-zinc-200 shadow-3xl relative overflow-hidden group">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-black tracking-tight uppercase">Leadership <span className="text-blue-600">Training Center</span></h2>
                        <p className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest mt-1">Professional Development Center // v4.0</p>
                    </div>
                </div>
                ...
                <div className="absolute inset-0 z-20 p-12 flex flex-col justify-between">
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            <span className="px-2 py-1 bg-blue-100 text-blue-600 rounded text-[8px] font-black uppercase tracking-widest">Global Leadership</span>
                    ...
                    <div className="flex items-end justify-between">
                        <div className="space-y-4">
                            ...
                            <a href="/career-growth" className="p-4 bg-zinc-900 text-white rounded-2xl flex items-center gap-4 shadow-lg active:scale-95 cursor-pointer hover:bg-zinc-800 transition-all">
                                <div className="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center">
                                    <Play fill="currentColor" size={16} />
                                </div>
                                <div>
                                    <p className="text-[10px] font-black uppercase tracking-widest">Start Program</p>
                                    <p className="text-[8px] text-zinc-400 uppercase tracking-widest leading-none mt-1">Duration: 15 min</p>
                                </div>
                            </a>
                        </div>
            ...
            <div className="mt-12 pt-8 border-t border-zinc-100">
                <div className="flex items-center justify-between mb-2">
                    <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Leadership Proficiency Index</p>
                    <span className="text-[10px] font-black text-blue-600 uppercase tracking-widest">84% Mastery</span>
                </div>
