        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full max-w-7xl mx-auto py-8">
            ...
            <div className="lg:col-span-3 space-y-4">
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 space-y-4">
                    ...
                    <div className="flex items-center gap-3 text-xs text-zinc-400 hover:text-white cursor-pointer transition-colors">
                        <Calendar size={14} /> Deployment Events
                    </div>
                </div>
            </div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4">
                    <div className="flex gap-4 mb-4">
                        ...
                        <input
                            ...
                            placeholder="Broadcast update to the network..."
            ...
            {/* Right Sidebar: Intelligence & News */}
            <div className="lg:col-span-3 space-y-4">
                <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="text-xs font-black text-zinc-400 uppercase tracking-widest">EdIntel News</h3>
                    ...
                    <ul className="space-y-4">
                        <li className="group cursor-pointer">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-xs font-bold text-zinc-300 group-hover:text-white truncate">AI Burnout Prevention</p>
                            </div>
                            <p className="text-[10px] text-zinc-500 pl-3.5">Top news • 4,102 readers</p>
                        </li>
                        <li className="group cursor-pointer">
                            <div className="flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-zinc-700 group-hover:bg-white transition-colors" />
                                <p className="text-xs font-bold text-zinc-300 group-hover:text-white truncate">New AL Code Regulations</p>
                            </div>
                            <p className="text-[10px] text-zinc-500 pl-3.5">Policy • 2h ago</p>
                        </li>
                        <li className="group cursor-pointer">
                            <div className="flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-zinc-700 group-hover:bg-white transition-colors" />
                                <p className="text-xs font-bold text-zinc-300 group-hover:text-white truncate">Sovereign Token Launch</p>
                            </div>
                            <p className="text-[10px] text-zinc-500 pl-3.5">Economics • 1d ago</p>
                        </li>
                    </ul>
                </div>
            </div>
