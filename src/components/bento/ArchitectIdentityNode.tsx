...
export default function ArchitectIdentityNode() {
    return (
        <div className="p-8 rounded-[2.5rem] bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10">
                <div className="flex items-start justify-between mb-8">
                    <div className="flex gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-zinc-400 font-medium">Sovereign Architect & AI Developer</p>
                ...
                <div className="mt-8 pt-6 border-t border-zinc-800 flex justify-between items-center">
                    <p className="text-[10px] font-mono text-zinc-600 uppercase tracking-widest">System Architect // ID: 11A75323</p>
