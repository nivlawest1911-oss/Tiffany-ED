...
export default function AvatarLaboratory() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const parsed: AvatarOutput = {
                ...
                tasks: extract(text, 'AUTOMATED_TASKS:', 'SOVEREIGN_ID:').split('\n').filter(t => t.trim()).map(t => t.replace(/^[0-9.-]+\s*/, '')),
                sid: extract(text, 'SOVEREIGN_ID:', null)
            };
    ...
    const extract = (text: string | undefined, start: string, end: string | null): string => {
        if (!text) return "Pending Synthesis";
        const s = text.indexOf(start);
        if (s === -1) return "Data Synced";
    ...
    const handleGenerateVideo = async () => {
        ...
        setVideoStatus('Initiating HeyGen Protocol...');
        ...
        try {
            ...
            const pollStatus = async () => {
                ...
                if (status.status === 'completed') {
                    ...
                    setVideoStatus('Sync Failed');
                    setIsGeneratingVideo(false);
                } else {
                    setVideoStatus(`Synthesizing Visuals: ${status.status}...`);
            ...
            console.error(e);
            setIsGeneratingVideo(false);
            setVideoStatus('Error Connecting to HeyGen');
        }
    };
            ...
            <div className="relative z-10">
                <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-mono text-zinc-500 uppercase tracking-[0.3em]">Hyperrealistic Agent Synthesis v5.0</p>
                        </div>
                    </div>
                    <div className="flex flex-col items-end">
                        <div className="flex items-center gap-2 px-4 py-2 bg-purple-950/30 border border-purple-500/30 rounded-2xl shadow-lg shadow-purple-900/20">
                            ...
                            <span className="text-[10px] font-bold text-purple-400 uppercase tracking-widest">HeyGen-Grade Sync</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="space-y-8 animate-in fade-in duration-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-6">
                                <div>
                                    <label className="block text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] mb-4">Neural Signature Profile</label>
                            ...
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    <div className="relative">
                                        <input
                                            ...
                                            placeholder="Identifier Name (e.g., Nexus-1)"
                                ...
                                <div className="p-6 rounded-3xl bg-zinc-900/30 border border-zinc-800">
                                    <div className="flex justify-between items-center mb-6">
                                        <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Autonomy Calibration</span>
                                    ...
                                    <div className="flex justify-between mt-3 text-[9px] font-bold text-zinc-600 uppercase tracking-tighter">
                                        ...
                                        <span>Full Sovereign Agent</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                <div className="p-8 rounded-[2.5rem] bg-zinc-900/50 border border-zinc-800 relative overflow-hidden group/briefing">
                                    {/* High-Fidelity Briefing Backdrop */}
                                    <img
                                        src="/images/labs-bg.jpg"
                                        className="absolute inset-0 w-full h-full object-cover opacity-10 group-hover/briefing:opacity-20 transition-opacity duration-1000"
                                        alt="Briefing Room"
                                    />
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            <span className="text-[10px] font-black text-zinc-600 uppercase tracking-widest block mb-2 text-center lg:text-left">Mission Vector</span>
                                        ...
                                        <div>
                                            <span className="text-[10px] font-black text-zinc-600 uppercase tracking-widest block mb-2">Cognitive profile</span>
                                        ...
                                        <div>
                                            <span className="text-[10px] font-black text-zinc-600 uppercase tracking-widest block mb-4">Automated Task Matrix</span>
                ...
                <div className="mt-12 p-8 rounded-[2.5rem] bg-zinc-900/20 border border-zinc-800/50 relative group/captions overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                <h3 className="text-lg font-black tracking-tight uppercase">Sovereign Captions Hub</h3>
                ...
                <div className="mt-12 pt-8 border-t border-zinc-900 flex items-center justify-between opacity-30">
                    <div className="flex gap-6">
                        ...
                        <span className="text-[9px] font-mono tracking-widest uppercase">Node: TRANSCEND-DIRECTOR-01</span>
                    </div>
