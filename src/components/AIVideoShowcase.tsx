...
const AI_VIDEOS: VideoShowcase[] = [
    ...
    },
    {
        ...
        brieferAvatar: "/images/avatars/dr_alvin_west_official.png"
    },
    {
        id: 4,
    ...
    },
    {
        ...
        videoUrl: '/videos/Health_for_Alabamas_Educators.mp4',
        duration: '4:40',
        category: 'Literacy',
        aiGenerated: true,
    ...
    },
    {
        ...
        videoUrl: '/videos/Burnout_Fix_Awaits.mp4',
        duration: '2:15',
        category: 'Identity',
        aiGenerated: true,
    ...
    },
    {
        ...
        videoUrl: '/videos/EdIntel_Noise-Free_Teaching.mp4',
        duration: '6:30',
        ...
        const buildAndSpeak = (voices: SpeechSynthesisVoice[]) => {
            ...
            if (isAlvin) {
                preferredVoice = voices.find(v =>
                    v.name === 'Daniel' || v.name.includes('Google UK English Male') || v.name.includes('Rocko')
                ) || voices.find(v => v.name.includes('David'));
            } else if (isMale) {
                preferredVoice = voices.find(v =>
                    (v.name.includes('Male') || v.name.includes('Guy') || v.name.includes('David')) && v.lang.startsWith('en')
                );
            } else {
                preferredVoice = voices.find(v =>
                    (v.name.includes('Female') || v.name.includes('Samantha') || v.name.includes('Zira')) && v.lang.startsWith('en')
                );
            }
                                            ...
                                            <div className="relative">
                                                <div className={`w-16 h-16 rounded-full p-0.5 bg-gradient-to-br from-[#c5a47e] to-[#d4af37] shadow-lg ${isSpeaking ? 'shadow-[#c5a47e]/40 scale-105' : 'grayscale-[0.3]'} transition-all duration-300`}>
                                                    <div className="w-full h-full rounded-full overflow-hidden bg-black border-2 border-black relative">
                                                        ...
                                                        >
                                                            <Image
                                                                src={selectedVideo.brieferAvatar || "/images/avatars/dr_alvin_west_official.png"}
