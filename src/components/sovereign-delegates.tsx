...
const delegates = [
    {
        id: "principal",
        name: "Dr. A.I. West",
        role: "Digital Superintendent",
        expertise: "Leadership & Policy",
        image: "/avatars/principal.jpg",
        color: "#d4af37",
        status: "Online",
        bio: "Serialized from the cognitive patterns of Dr. Alvin West, this node specializes in high-level district strategy, board relations, and crisis management.",
        competencies: ["Policy Synthesis", "Stakeholder Alignment", "Vision Architecting"],
        promptId: "email-composer"
    },
    {
        id: "counselor",
        name: "Sarah Connors",
        role: "Lead Counselor Node",
        expertise: "SEL & Behavior",
        image: "/avatars/counselor.jpg",
        color: "#10b981",
        status: "Busy",
        bio: "Focuses on the socio-emotional fabric of the campus. Expert in de-escalation scripts, restorative justice frameworks, and mental health resource mapping.",
        competencies: ["Crisis Intervention", "SEL Curriculum", "Behavioral Audits"],
    ...
    },
    {
        ...
        color: "#00d2ff",
        status: "Online",
        bio: "A logic-driven pedagogue. Ensures all instructional materials map strictly to Alabama Course of Study standards while maximizing engagement.",
    ...
    },
    {
        ...
        expertise: "Assessments & ROI",
        image: "/avatars/data.jpg",
        color: "#8b5cf6",
        status: "Processing",
        bio: "Parses complex datasets to find actionable insights. Turns test scores and attendance records into strategic funding narratives.",
    ...
    },
    {
        ...
        color: "#f59e0b",
        status: "Online",
        bio: "The shield of the district. Monitors all documentation for legal vulnerabilities and ensures 100% audit readiness.",
        competencies: ["Legal Shielding", "Audit Prep", "Due Process"],
        promptId: "policy-advisor"
    }
]

export function SovereignDelegates() {
    ...
    const handleDeploy = (promptId: string) => {
        ...
        if (element) {
            ...
            // In a real app, we'd pre-select the generator here via Context
        }
    }
                ...
                <div className="flex items-end justify-between mb-12">
                    <div>
                        <h2 className="text-3xl md:text-5xl font-black text-white mb-2">
                            Sovereign <span className="gradient-text">Delegates</span>
                        </h2>
                        <p className="text-gray-400">Select your autonomous AI staff member.</p>
                    </div>
                            ...
                            <div className={`absolute inset-0 bg-[#0a0f1c] rounded-3xl border border-white/10 overflow-hidden transition-all duration-500 ${activeDelegate === delegate.id ? 'scale-105 shadow-[0_0_30px_rgba(0,0,0,0.5)] border-white/30' : 'group-hover:scale-102'}`}>
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-8">
                                    ...
                                    <button
                                        ...
                                        {activeDelegate === delegate.id ? "Initialize Link" : "View Profile"}
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-[#0a0f1c] border border-white/10 w-full max-w-2xl rounded-3xl overflow-hidden shadow-2xl relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="p-8 bg-zinc-900/50">
                                ...
                                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-3">BIO-DATA</h4>
                                <p className="text-sm text-gray-300 leading-relaxed mb-6">
                                    {selectedDelegate.bio}
                                </p>

                                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-3">CORE PROTOCOLS</h4>
