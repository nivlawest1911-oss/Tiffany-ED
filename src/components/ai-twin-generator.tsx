            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="glass-card p-8 rounded-3xl">
                        ...
                        {twinCreated ? (
                            <div className="space-y-6">
                                <div className="relative aspect-video rounded-2xl overflow-hidden bg-gradient-to-br from-[#6b46c1] to-[#d4af37] flex items-center justify-center">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl">
                                        ...
                                        <p className="text-sm text-emerald-400">
                                            "Hello! I'm {twinName}, your AI {twinRole}. How can I assist you today?"
                                        </p>
                                    </div>
                ...
                <div className="mt-12 glass-card p-8 rounded-3xl">
                    ...
                    <div className="aspect-video rounded-2xl overflow-hidden bg-black">
                        ...
                        >
                            <source src="/videos/ai-twin-demo.mp4" type="video/mp4" />
