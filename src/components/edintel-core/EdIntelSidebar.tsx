...
export function EdIntelSidebar({
    agentStatus = "Active",
    hoursSaved = 14.2,
            ...
            <div className="p-8 border-b border-white/10 bg-white/[0.02] flex items-center justify-between">
                <div>
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <h2 className="text-[11px] font-black uppercase tracking-[0.3em] text-white italic">EdIntel Swarm</h2>
                    </div>
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <EdIntelInteractionAgent
                            title="Network State"
                            description="Real-time connectivity status of the EdIntel Intelligence Layer across your district network."
                            agentId="tactical"
                            position="left"
                            className="w-full"
                        >
