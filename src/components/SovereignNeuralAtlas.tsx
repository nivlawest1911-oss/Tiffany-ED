...
const ALABAMA_SCHOOL_NODES = [
    ...
    { name: "Opelika High School", district: "Opelika City", type: "High School", students: "1,400", status: "Awaiting Uplink", efficiency: "78%" },
...
export default function SovereignNeuralAtlas() {
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 mb-12">
                    <div className="relative flex-1 group">
                        ...
                        <input
                            type="text"
                            placeholder={view === 'alabama' ? "Deep Scan Alabama Schools (Name, District, NCES)..." : "Locate National Strategic Nodes..."}
                            value={searchTerm}
                ...
                <div className="relative">
                    ...
                    {(view === 'alabama' ? filteredAlabama.length : filteredNational.length) === 0 && (
                        <div className="py-32 text-center">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">Node Not Located.</h3>
                            <p className="text-zinc-500">The current search criteria did not match any active educational nodes in our neural atlas.</p>
                        </div>
                    )}
                </div>
                ...
                <div className="mt-20 grid md:grid-cols-3 gap-8">
                    {[
                        { icon: Activity, label: "Live Uplink Capacity", value: "99.98%", sub: "Global Node Stability" },
                        { icon: Target, label: "Search Indexing", value: "114,000+", sub: "US Educational Entities" },
                        { icon: Cpu, label: "Neural Processing", value: "2.4ms", sub: "Atlas Scann Rate" }
                    ].map((stat, i) => (
