...
export default function EdIntelApiVault() {
    ...
    const services = [
        ...
        { id: 'vertex', label: 'Vertex AI Super', icon: Zap, color: 'text-amber-400', desc: 'EdIntel Intelligence' },
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between mb-6 relative z-10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-sm font-bold text-white uppercase tracking-widest">EdIntel Vault</h3>
