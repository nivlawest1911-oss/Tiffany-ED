...
export default function EdIntelAdvisorInterface() {
    ...
    if (!isSessionActive && !isConnecting) {
        return (
            ...
            >
                ...
                <h2 className="text-2xl font-black text-white mb-2 uppercase italic tracking-tight">EdIntel Advisor <span className="text-cyan-400">Uplink</span></h2>
