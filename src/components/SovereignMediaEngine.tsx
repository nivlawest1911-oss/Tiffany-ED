...
interface SovereignMediaEngineProps {
    type: 'video' | 'image';
    src: string;
    alt?: string;
    className?: string;
...
export default function SovereignMediaEngine({
    type,
    src,
    alt = 'Sovereign Asset',
    className = '',
                ...
                <div className="flex items-end justify-between">
                    <div>
                        ...
                        <div className="flex items-center gap-2 text-white/60">
                            ...
                            <span className="text-[8px] font-black uppercase tracking-[0.3em]">Sovereign Optical Array</span>
                        </div>
                    </div>
