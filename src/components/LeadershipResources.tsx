...
interface ResourceCategory {
    alabama: ResourceItem[];
    mobile: ResourceItem[];
}

const TEACHER_RESOURCES: ResourceCategory = {
    alabama: [
        {
...
const ADMIN_RESOURCES: ResourceCategory = {
    alabama: [
        {
        ...
        <section className="bg-black relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
                    <div>
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-zinc-400 text-[10px] font-bold uppercase tracking-[0.3em] mb-4">
                            ...
                            <span>Academic & Leadership Resources</span>
                        </div>
                        <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter leading-none mb-4">
                            Essential <br /> <span className="text-zinc-600 italic">Resources.</span>
                        </h2>
                        <p className="text-zinc-500 max-w-xl text-sm leading-relaxed">
                            Access professional resources tailored for {mode === 'teacher' ? 'Alabama Educators' : 'Alabama Administrators'}. Switch the view mode to see regional resources.
                        </p>
                    </div>
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-500 text-xs">
                                        {mode === 'teacher'
                                            ? 'Ensure your classroom environment aligns with the latest Science of Reading benchmarks.'
                                            : 'Professional development tracks for district-wide administrative excellence.'}
                                    </p>
                                </div>
                            </div>
                ...
                <div className="grid lg:grid-cols-12 gap-16 items-start">
                    {/* Left: Local Resources */}
                    <div className="lg:col-span-4 space-y-6">
                        <h3 className="text-[10px] font-bold text-zinc-600 uppercase tracking-[0.3em] mb-4">Mobile County Resources</h3>
                        ...
                        <div className="mt-8 p-8 rounded-[2rem] bg-indigo-500/5 border border-indigo-500/10">
                            <div className="flex items-center gap-3 mb-4 text-indigo-400">
                                <Lightbulb size={20} />
                                <span className="text-xs font-bold uppercase tracking-widest">EdIntel Tip</span>
                            </div>
                            <p className="text-xs text-zinc-500 leading-relaxed italic">
                                "{mode === 'teacher' ? 'Teacher' : 'Admin'} resources are updated in real-time with MCPSS policy changes. Ask the AI Assistant for deep analysis of any professional standard."
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-8">
                        <h3 className="text-[10px] font-bold text-zinc-600 uppercase tracking-[0.3em] mb-8 px-2">Alabama Strategic Resources</h3>
                        ...
                        <div className="mt-8 p-10 rounded-[3rem] bg-white/5 border border-white/5 flex flex-col md:flex-row items-center justify-between gap-10">
                            <div className="flex gap-6 items-start">
                                ...
                                <div className="max-w-md">
                                    ...
                                    <p className="text-zinc-500 text-sm">Access the professional archive of ALSDE legislative updates and Montgomery session summaries relevant to district leadership.</p>
                                </div>
                            </div>
