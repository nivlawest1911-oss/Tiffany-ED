...
const LiveAvatarChat = dynamic(() => import('@/components/LiveAvatarChat'), {
    ssr: false,
    loading: () => <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-3xl flex items-center justify-center"><Loader2 className="w-12 h-12 text-noble-gold animate-spin" /></div>
});
