...
const resources = [
  ...
  {
    title: "Strategic Sync & Recidivism (CBI Studies)",
    ...
    <section className="px-4 md:px-8 py-16">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="font-black tracking-tighter text-3xl md:text-4xl text-white mb-2">Compliance Vault</h2>
        ...
        {/* Regional Gateway */}
        <div className="glass-card-emerald p-6 rounded-2xl mb-8 relative overflow-hidden group">
          {/* Scanning Effect */}
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#00d2ff]/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />

          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 relative z-10">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-[#00d2ff]/20 flex items-center justify-center relative">
                <Scale className="w-6 h-6 text-[#00d2ff]" />
                <span className="absolute top-0 right-0 w-3 h-3 bg-red-500 rounded-full animate-bounce border-2 border-[#1a1a1a]" />
              </div>
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wider flex items-center gap-2">
                  Regional Gateway
                  <span className="inline-block w-1 h-1 bg-[#00d2ff] rounded-full animate-pulse" />
                </p>
                <h3 className="font-black tracking-tighter text-xl text-white">Alabama Command Center</h3>
              </div>
            </div>
            <div className="text-left md:text-right">
              <span className="text-xs text-[#00d2ff] font-mono bg-[#00d2ff]/10 px-2 py-1 rounded border border-[#00d2ff]/20">SYNC_STATUS: ACTIVE</span>
              <p className="text-xs text-gray-400 mt-1">6 new resources including Digital Literacy Standards</p>
            </div>
          </div>
        </div>
