        ...
        <section className="w-full bg-black/60 border-t border-intel-gold/10 backdrop-blur-3xl py-20 px-12 relative overflow-hidden">
                ...
                <div className="md:col-span-4 space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-600 block mt-1">EdIntel OS // v5.1</span>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                >
                    ...
                    <span className="text-[10px] font-black text-zinc-600 uppercase tracking-widest group-hover:text-intel-gold transition-colors">Neural Grid Active // {new Date().getFullYear()} EdIntel OS</span>
                </button>
