        ...
        <div className="flex h-screen bg-black text-white font-sans overflow-hidden selection:bg-intel-gold selection:text-black">
                ...
                <aside className="hidden md:flex w-24 hover:w-72 bg-black border-r border-intel-gold/10 transition-all duration-500 ease-in-out group z-50 flex-col items-center py-8 relative">
                    ...
                    <div className="w-full px-6 pt-8 border-t border-white/5 mt-auto">
                        <div className="flex flex-col items-center gap-6 opacity-40 group-hover:opacity-100 transition-opacity pb-8">
                            ...
                            >
                                <BrainCircuit className={`w-5 h-5 ${isHudExpanded ? 'scale-110' : ''}`} aria-hidden="true" />
                            </button>
            ...
            <div className="flex-1 flex flex-col relative overflow-hidden">
                ...
                <header className="h-20 md:h-24 border-b border-white/[0.04] flex items-center justify-between px-6 md:px-12 bg-black/40 backdrop-blur-3xl relative z-40">
                    <div className="flex items-center gap-12">
                        ...
                        {!isMarketingRoute && (
                            <div className="hidden sm:flex items-center gap-4 group cursor-default">
                                <div className="w-2.5 h-2.5 rounded-full bg-shield-green animate-pulse shadow-[0_0_15px_rgba(16,185,129,0.5)]" aria-hidden="true" />
                                <span className="text-[10px] font-black font-mono text-zinc-300 uppercase tracking-[0.5em] italic">Due Process Shield: Active</span>
                            </div>
                        )}

                        <div className="hidden xl:flex items-center gap-3 px-6 py-2.5 bg-white/[0.02] border border-white/5 rounded-full">
                             <span className="text-[9px] font-black text-zinc-300 uppercase tracking-[0.4em] italic">Usage Tokens: <span className="text-white ml-2">951.4k</span></span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 md:gap-8">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                <Facebook className="w-4 h-4 group-hover/fb:scale-110 transition-transform" aria-hidden="true" />
                            </button>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar relative flex flex-col">
                                ...
                                <section className="text-center mb-16 md:mb-24 relative">
                                    ...
                                    >
                                        <h1 className="text-5xl md:text-8xl font-black italic tracking-tighter text-gold-gradient uppercase leading-[0.9]">
                                         ...
                                         <p className="mt-6 md:mt-10 text-lg md:text-xl text-zinc-300 max-w-3xl mx-auto font-black italic leading-relaxed uppercase tracking-tight opacity-80">
                    ...
                    >
                        <Search className="w-6 h-6 sm:w-7 sm:h-7 group-hover:scale-110 transition-transform" aria-hidden="true" />
                    </button>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
                                ...
                                <div className="col-span-1 md:col-span-4 space-y-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <span className="text-[10px] text-zinc-300 uppercase tracking-[0.3em] font-bold">Operating System v4.0</span>
                                        </div>
                                    </div>
                                    <p className="text-xs text-zinc-300 leading-relaxed max-w-sm uppercase tracking-wide font-medium">
                                ...
                                <div className="col-span-1 md:col-span-3 space-y-6">
                                    ...
                                    <ul className="space-y-3">
                                         <li><Link href="/identity" className="text-xs text-zinc-300 hover:text-intel-gold uppercase tracking-widest transition-colors font-bold">Data Identity</Link></li>
                                        <li><Link href="/ferpa" className="text-xs text-zinc-300 hover:text-intel-gold uppercase tracking-widest transition-colors font-bold">Federal Compliance</Link></li>
                                        <li><Link href="/admin/status" className="text-xs text-zinc-300 hover:text-intel-gold uppercase tracking-widest transition-colors font-bold">Grid Status</Link></li>
                                        <li><Link href="/admin" className="text-xs text-zinc-300 hover:text-intel-gold uppercase tracking-widest transition-colors font-bold">Admin Portal</Link></li>
                                        <li><Link href="/privacy" className="text-xs text-zinc-300 hover:text-intel-gold uppercase tracking-widest transition-colors font-bold">Privacy Policy</Link></li>
                                        <li><Link href="/terms" className="text-xs text-zinc-300 hover:text-intel-gold uppercase tracking-widest transition-colors font-bold">Terms of Service</Link></li>
                                        <li><Link href="/support" className="text-xs text-zinc-300 hover:text-intel-gold uppercase tracking-widest transition-colors font-bold">Support Center</Link></li>
                                    </ul>
                                </div>
                            </div>
