...
export default function SovereignHeader() {
    ...
    return (
        <header className="fixed top-0 left-20 right-0 h-20 z-40 px-10 flex items-center justify-between border-b border-intel-gold/10 bg-sovereign-black/80 backdrop-blur-3xl">
            {/* System Title Area */}
