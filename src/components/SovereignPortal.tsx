                        ...
                        <div className="relative aspect-video bg-zinc-900">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 via-zinc-900 to-black flex items-center justify-center">
                                <div className="text-center opacity-50">
                                    <Video className="w-12 h-12 mx-auto mb-2 text-indigo-400" />
                                    <p className="text-[10px] uppercase font-bold tracking-widest text-indigo-300">Sovereign Twin Active</p>
                                </div>
                            </div>
