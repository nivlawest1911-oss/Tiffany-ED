...
export const SovereignIDManager = ({ userSubscription }: SovereignIDManagerProps) => {
    ...
    return (
        <SovereignNode
            title="IDENTITY MANAGER // NODE-01"
            videoSrc="/videos/dashboard/biometric-scan.mp4"
            fallbackImage="/images/dashboard/biometric-fallback.jpg"
            actionText={isExpired ? 'UPGRADE NOW' : 'VIEW SUBSCRIPTION'}
            onAction={() => console.log('Opening subscription...')}
            delay={0.2}
        >
