...
export default function NeuralReferralNode() {
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-zinc-400 mb-8 leading-relaxed">
                                Our network grows stronger with every node. Invite 3 educators to join the Sovereign Collective and unlock <strong>Month of Professional Access</strong> instantly.
                            </p>
                        ...
                        <div className="w-full md:w-auto p-6 bg-black rounded-3xl border border-zinc-800 shadow-2xl relative group">
                            <h3 className="text-sm font-bold text-zinc-400 uppercase tracking-wider mb-4 text-center">Your Neural Link</h3>
                            ...
                            <p className="text-[10px] text-zinc-600 text-center mt-4 px-4">
                                *Referring 10+ users grants "Sovereign Ambassador" status and 1% permanent revenue share (Beta).
                            </p>
