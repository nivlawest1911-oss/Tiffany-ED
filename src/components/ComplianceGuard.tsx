                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-zinc-300 leading-snug mb-2">
                            Session monitored for <span className="text-white font-bold">FERPA / IDEA</span> & <a href="https://alabamaadministrativecode.state.al.us/docs/ed/290-8-9.pdf" target="_blank" rel="noopener noreferrer" className="text-white font-bold hover:text-emerald-400 underline decoration-dotted underline-offset-2 transition-colors">State Code</a> compliance.
                        </p>
