                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex gap-3">
                            <motion.a
                                ...
                                className="p-3 rounded-xl bg-white/5 hover:bg-[#ff0050]/20 text-zinc-300 hover:text-[#ff0050] transition-all border border-white/5 hover:border-[#ff0050]/30 hover:shadow-[0_0_20px_rgba(255,0,80,0.2)]"
                            ...
                            <motion.a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="p-3 rounded-xl bg-white/5 hover:bg-[#1877F2]/20 text-zinc-300 hover:text-[#1877F2] transition-all border border-white/5 hover:border-[#1877F2]/30 hover:shadow-[0_0_20px_rgba(24,119,242,0.2)]"
                            ...
                            <motion.a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="p-3 rounded-xl bg-white/5 hover:bg-[#0077b5]/20 text-zinc-300 hover:text-[#0077b5] transition-all border border-white/5 hover:border-[#0077b5]/30 hover:shadow-[0_0_20px_rgba(0,119,181,0.2)]"
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><Link href="/login" className="text-zinc-300 hover:text-[#00E5FF] transition-colors text-sm font-medium">Protocol Login</Link></li>
                            <li><Link href="/signup" className="text-zinc-300 hover:text-[#00E5FF] transition-colors text-sm font-medium">Initialize Account</Link></li>
                            <li><Link href="/videos" className="text-zinc-300 hover:text-[#00E5FF] transition-colors text-sm font-medium">Video Library</Link></li>
                            <li><Link href="/support" className="text-zinc-300 hover:text-[#00E5FF] transition-colors text-sm font-medium">Support Center</Link></li>
                            <li><Link href="/connectors" className="text-zinc-300 hover:text-[#00E5FF] transition-colors text-sm font-medium">Connector Hub</Link></li>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-300 text-xs">Founder & Chief Professional Officer</p>
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="p-1.5 rounded-lg bg-[#00E5FF]/10 text-[#00E5FF] mt-0.5 border border-[#00E5FF]/20"><Mail size={14} /></span>
                                <div className="space-y-1">
                                    <a href="mailto:dralvinwest@transcendholisticwellness.com" className="text-zinc-300 hover:text-[#FFB300] transition-colors text-sm block truncate max-w-[200px]" title="dralvinwest@transcendholisticwellness.com">
                                        dralvinwest@transcendholisticwellness.com
                                    </a>
                                    <a href="mailto:nivlawest1911@gmail.com" className="text-zinc-300 hover:text-[#FFB300] transition-colors text-sm block">
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <a href="https://wa.me/12512296351" target="_blank" rel="noopener noreferrer" className="text-zinc-300 hover:text-[#25D366] transition-colors text-sm">
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <a href="tel:+14086577099" className="text-zinc-300 hover:text-[#00E5FF] transition-colors text-sm">
                ...
                <div className="border-t border-[#FFB300]/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="text-zinc-300 text-xs flex items-center gap-2 hover:text-emerald-400 transition-colors group cursor-pointer"
                        >
