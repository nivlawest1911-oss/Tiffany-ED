...
export default function EdIntelClient() {
    ...
    return (
        <main className="content-stage">
            {/* Hero Section with EdIntel Director */}
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-zinc-400 leading-relaxed mb-8">
                            EdIntel EdIntel is our revolutionary AI engine that transforms chaotic educational data into crystal-clear insights. Like a storm brewing in a server room, it processes miles of tangled information and activates with a pulse of golden intelligence.
                        </p>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-xl text-zinc-400">
                            Eight pillars of EdIntel AI technology
                        </p>
                    </motion.div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <div className="space-y-6 text-zinc-300 leading-relaxed">
                            ...
                            <p>
                                <span className="text-amber-400 font-bold">Scene 2: The Activation</span> — A pulse of gold light ripples from the center. The crystalline core appears—solid, metallic, heavy. The EdIntel engine awakens, transforming chaos into clarity.
                            </p>
                            <p className="text-white font-bold">
                                This is EdIntel EdIntel. This is the future of educational AI.
                            </p>
                        </div>
                    </motion.div>
                </div>
            ...
            <section className="py-20 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <h2 className="text-4xl font-black text-white mb-4">
                            Ready to Activate EdIntel?
                        </h2>
                        <p className="text-xl text-zinc-400 mb-8">
                            Transform your district's data into actionable intelligence with the power of EdIntel AI
                        </p>
                        <div className="flex flex-wrap justify-center gap-4">
