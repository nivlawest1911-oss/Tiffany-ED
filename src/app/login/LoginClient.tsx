    ...
    const handleAuth = async (e: React.FormEvent) => {
        ...
        try {
            if (mode === 'login') {
                ...
                // Signup via Supabase
                if (!supabase) {
                    throw new Error('Supabase is not configured. Please contact your administrator.');
                }
            ...
            <div className="min-h-screen content-stage flex items-center justify-center p-4 relative overflow-hidden bg-[#020617]">
                ...
                >
                    ...
                    <div className="p-8 lg:p-14 flex flex-col justify-center relative bg-white/5">
                        ...
                        {/* SOCIAL LOGIN BLOCK — PRIMARY METHOD */}
                        <div className="grid grid-cols-2 gap-4 mb-8">
                            ...
                            >
                                {isSocialLoading === 'google' ? (
                                    ...
                                    <svg className="w-5 h-5" viewBox="0 0 24 24">
                                        ...
                                        <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 2.18 2.18 5.38l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z" />
                                    </svg>
                                )}
                            ...
                            <button
                                ...
                                type="button"
                                disabled={isSocialLoading !== null}
                                className="flex items-center justify-center gap-2 py-4 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-[#1877F2]/50 transition-all group disabled:opacity-50 shadow-sm"
                            >
                        ...
                        <div className="relative mb-10">
                            ...
                            <div className="relative flex justify-center">
                                <span className="bg-[#0b1021] px-4 text-[9px] font-black text-zinc-400 uppercase tracking-widest">OR USE EMAIL & PASSWORD</span>
                            </div>
                        </div>
