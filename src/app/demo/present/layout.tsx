...
import { 
  LayoutDashboard, Users, TrendingUp, BookOpen, ShieldCheck, LogOut, Target, Layers, Award, Scale, Microscope, AppWindow, Globe, DollarSign, Zap, Briefcase, CreditCard, Database, Rocket, Brain
} from 'lucide-react';
...
export default function PresentLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: '/demo/present/district-brain', label: 'District Brain (UDOS)', icon: Brain },
