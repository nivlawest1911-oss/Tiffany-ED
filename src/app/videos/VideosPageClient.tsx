...
import {
  ...
  ParticleField,
  LaserLine,
} from '@/components/ui/HolographicUI';
  ...
  loading: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {Array.from({ length: 6 }).map((_, i) => (
        <div
          key={i}
          className="aspect-video animate-pulse rounded-2xl bg-zinc-800/80"
        />
      ))}
    </div>
  ),
    ...
    <div className="min-h-screen bg-[#050505] relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 text-center">
          ...
          >
            <HolographicText variant="gradient" as="span">
              Video Library
            </HolographicText>
          </motion.h1>
                ...
                <div className="absolute inset-0 flex items-center justify-between p-8 md:p-12">
                  <div className="max-w-xl">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-[#FFB300] text-[10px] font-black uppercase tracking-widest">
                        Featured Content
                      </span>
                    </div>
                    <HolographicText
                      variant="gold"
                      as="h2"
                      className="text-2xl md:text-4xl font-black uppercase tracking-tight mb-3"
                    >
                      {videos[0]?.title || 'Strategic Briefings'}
                    </HolographicText>
                    <p className="text-zinc-400 text-sm md:text-base line-clamp-2">
                      {videos[0]?.description ||
                        'Explore our collection of professional development videos, tutorials, and strategic briefings.'}
                    </p>
                  </div>
                  ...
                  {videos[0] && (
                    <Link
                      ...
                      aria-label={`Watch featured video: ${videos[0].title}`}
                    >
                      <motion.div
        ...
        >
          <GlassPanel variant="cyan" className="p-8 text-center">
            ...
            <p className="text-zinc-400 mb-6 max-w-md mx-auto">
              Need specific training videos or briefings for your district? Contact our media team
              to request custom content.
            </p>
            <Link href="/contact">
              <motion.button
