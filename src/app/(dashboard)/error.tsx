...
export default function DashboardError({
    ...
    return (
        <section className="min-h-[60svh] sm:min-h-[70svh] flex items-center justify-center px-4 py-8" role="alert" aria-label="Error occurred">
            <div className="bg-gray-900/80 border border-gray-800 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-10 max-w-md w-full text-center relative overflow-hidden">
                {/* Top accent bar */}
                <div className="absolute top-0 left-0 w-full h-1 sm:h-1.5 bg-red-500" aria-hidden="true" />
                
                {/* Icon container */}
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-red-500/10 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 text-red-500" aria-hidden="true">
                    <svg className="w-8 h-8 sm:w-10 sm:h-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                ...
                <div className="flex flex-col gap-3" role="group" aria-label="Error recovery options">
                    <button
                        onClick={() => reset()}
                        type="button"
