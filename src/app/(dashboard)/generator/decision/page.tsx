        ...
        try {
            const response = await fetch('/api/generate/decision', {
                ...
                body: JSON.stringify({
                    scenario,
                    context,
                    stakeholders: stakeholderList.join(", "),
                    riskTolerance
                })
            });
            ...
            addAction(`Decision Matrix Generated`);
            toast.success("Strategic Decision Matrix ready.");
        } catch (err: any) {
                ...
                <header className="mb-12">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-white uppercase">
                            Decision <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-500 italic">Engine</span>
                        </h1>
                    ...
                    >
                        <Card className="bg-zinc-900/40 backdrop-blur-xl border-white/5 overflow-hidden">
                            ...
                            <CardContent className="p-6 space-y-5">
                                ...
                                <Button
                                    className="w-full h-12 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-black uppercase tracking-widest rounded-xl shadow-lg transition-all group"
                                ...
                                >
                                    ...
                                    {isGenerating ? 'Analyzing Matrices...' : 'Generate Action Matrix'}
                                </Button>
                            </CardContent>
                        </Card>
                    </motion.div>
