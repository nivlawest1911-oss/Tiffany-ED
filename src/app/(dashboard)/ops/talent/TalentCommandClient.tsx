...
export default function TalentCommandClient() {
                    ...
                    <div className={`p-6 rounded-3xl border transition-all duration-500 ${isRescueOneActive ? 'bg-rose-500/5 border-rose-500/20' : 'bg-pink-500/5 border-pink-500/20'}`}>
                        ...
                        <ul className="space-y-3">
                            <li className="text-[11px] text-zinc-400 leading-relaxed flex gap-3">
                                ...
                                <span className="font-semibold text-white">Directive 01:</span> Prioritize emotional safety protocols for secondary staff before Q3 transition.
                            </li>
                            <li className="text-[11px] text-zinc-400 leading-relaxed flex gap-3">
                                <span className={`shrink-0 w-1 h-1 rounded-full mt-1.5 ${isRescueOneActive ? 'bg-rose-500' : 'bg-pink-500'}`} />
                                <span className="font-semibold text-white">Directive 02:</span> Deploy 'Recognition Pulse' for Grade 9 leads to offset systemic fatigue.
                            </li>
                        </ul>
                    </div>
                </div>
