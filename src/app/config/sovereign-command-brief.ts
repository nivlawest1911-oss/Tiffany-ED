export const EdIntel_COMMAND_BRIEF = {
    ...
    roiProjection: {
        ...
        contentProduction: "Replaces external agency costs for district media with internal AI-driven tools.",
        compliance: "Automates ADA subtitle compliance, mitigating district liability risks.",
