                            ...
                            <TabsContent value="overview" className="mt-0">
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        {[
                                            { icon: BookOpen, title: 'Create Lesson', desc: 'AI-powered lesson planning', action: () => setActiveTab('meta-ai') },
                                            { icon: Video, title: 'Generate Video', desc: 'Create avatar videos instantly', action: () => setActiveTab('avatar-video') },
                                            { icon: GraduationCap, title: 'Analyze Work', desc: 'AI student work analysis', action: () => setActiveTab('meta-ai') },
                                        ].map((action, index) => (
                                            <motion.button
                                                key={action.title}
